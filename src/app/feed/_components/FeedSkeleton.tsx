      ...
      <div className="w-full overflow-x-auto p-2">
        ...
        <div className="flex gap-4">
          {[...Array(4)].map((_, index) => (
            <Card
              key={index}
              className="min-w-[320px] max-w-[320px] rounded-sm my-0 border-none  overflow-hidden"
            >
      ...
      <div className="lg:grid lg:grid-cols-[2fr_1fr] lg:gap-12 ">
        <div>
          ...
          <div role="list" aria-label="Question feed">
            {[...Array(3)].map((_, index) => (
              <Card
                key={index}
                className="mb-4 border-none rounded-lg overflow-hidden"
              >
        ...
        <aside className="hidden lg:block">
          <div className="sticky top-20">
            <Card className="border shadow-none rounded-lg p-4">
              <Skeleton className="h-4 w-full" />
